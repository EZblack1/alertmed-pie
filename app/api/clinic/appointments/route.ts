...
// GET - Listar todas as consultas da clínica
export async function GET(request: NextRequest) {
  try {
    ...
    // Buscar estatísticas
    const { data: stats } = await supabase.from("appointments").select("status")
...
// POST - Agendar consulta como clínica
  ...
  try {
    ...
    const { data: appointment, error } = await supabase
      ...
      .insert({
        ...
        notes,
        location: location || "Clínica AlertMed",
