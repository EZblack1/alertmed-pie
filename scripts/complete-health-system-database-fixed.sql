...
-- Script único para Supabase - VERSÃO CORRIGIDA
-- ========================================
...
-- Função para criar horários de medicamento (CORRIGIDA)
...
DECLARE
  schedule_date DATE; -- Renomeado para evitar conflito
  schedule_time TIME;
  schedules_created INTEGER := 0;
BEGIN
  schedule_date := p_start_date; -- Usar variável renomeada
  
  WHILE schedule_date <= p_end_date LOOP
...
-- Trigger para criar horários de medicamento (CORRIGIDO)
